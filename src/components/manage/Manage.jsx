    ...
    <div>
      <Container>
        <div className='text-center mt-10 mb-6'>
          <h2 className='w-[542px] m-auto font-semibold text-[36px] text-header mb-4 '>Manage your entire community in a single system</h2>
          <p className='text-4 text-pera'>Who is Nextcent suitable for?
          </p>
        </div>
        <div className='md:flex md:justify-between md:items-center'>
          <div className='md:box-sizing md:border-box md:mt-10 md:mb-6 shadow-sm md:p-7  '>
