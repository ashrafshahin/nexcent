          ...
          <Container>
              <div className='md:flex justify-between'>
                  <div className='md:w-[35%]'>
                      ...
                      <p className='text-[12px]'>Copyright © 2025 Nexcent ltd.</p>
                      <p className='py-2 text-[12px]'>All rights reserved | Powered by Shahin</p>
                  ...
                  <div className='md:w-[20%] mt-8 md:mt-0'>
                  ...
                  <div className='md:w-[25%]'>
                      ...
                      <Button className='bg-white/20 inline-block md:block'>
                          <div className='flex justify-between items-center '>
                              <p className=' font-semibold md:text-[20px] text-white mr-2 '>Your email address</p>
